...
public class BrowserUtil {
	...
	static {
		...
		System.setProperty("webdriver.gecko.driver", System.getProperty("user.home") + "/"
				+ ConfigUtil.getProperty("webDriverRepositoryPath") + ConfigUtil.getProperty("firefoxDriverPath"));

		System.setProperty("webdriver.chrome.driver", System.getProperty("user.home") + "/"
				+ ConfigUtil.getProperty("webDriverRepositoryPath") + ConfigUtil.getProperty("chromeDriverPath"));

		System.setProperty("webdriver.ie.driver", System.getProperty("user.home") + "/"
				+ ConfigUtil.getProperty("webDriverRepositoryPath") + ConfigUtil.getProperty("ieDriverPath"));

		System.setProperty("webdriver.edge.driver", System.getProperty("user.home") + "/"
				+ ConfigUtil.getProperty("webDriverRepositoryPath") + ConfigUtil.getProperty("edgeDriverPath"));
	...
	public static void takeScreenshot(WebDriver driver, String url) {
		if (enableScreenshot) {
			...
			String screenShotFileName = System.getProperty("user.dir") + "/screenshots/" + generateFileNameFromUrl(url)
